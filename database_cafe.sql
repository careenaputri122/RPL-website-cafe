...
-- Sesuai SRS: autentikasi, menu+stok, meja, reservasi, pesanan,
-- detail pesanan, payment, verifikasi, dan laporan penjualan.
-- ============================================================
...
('Administrator', 'admin@cafe.com', '$2y$12$wHvJ0jRQXhOx04IV7gyYH./TmkV/geaO/kBflW258BGB3zvBIJdva', '081234567890');

INSERT INTO pelanggan (nama, email, no_telp, password) VALUES
('Budi Santoso', 'budi@email.com', '081234567891', '$2y$12$fnLwOc68pPxsTFSKzBUtM.WGnbyl1ZqIxS4EmQCyf/swRKtTyd9/C');
...
('Nasi Goreng Spesial', 'Makanan', 35000, 'Nasi goreng dengan telur, ayam suwir, dan bumbu rempah pilihan.', 'https://images.unsplash.com/photo-1603133872878-684f208fb84b?w=600&q=80', 1),
('Ayam Bakar Madu', 'Makanan', 42000, 'Ayam bakar dengan marinasi madu dan kecap, disajikan dengan lalapan.', 'https://images.unsplash.com/photo-1598515214211-89d3c73ae83b?w=600&q=80', 1),
('Mi Goreng Seafood', 'Makanan', 38000, 'Mi goreng dengan udang, cumi, dan sayuran segar.', 'https://images.unsplash.com/photo-1612929633738-8fe44f7ec841?w=600&q=80', 0),
('Soto Ayam Lamongan', 'Makanan', 28000, 'Soto ayam khas Lamongan dengan kuah bening gurih dan koya.', 'https://images.unsplash.com/photo-1569058242253-92a9c755a0ec?w=600&q=80', 0),
('Es Kopi Susu', 'Minuman', 22000, 'Kopi susu gula aren dengan espresso premium dan susu segar.', 'https://images.unsplash.com/photo-1461023058943-07fcbe16d735?w=600&q=80', 1),
('Matcha Latte', 'Minuman', 28000, 'Matcha premium Jepang dengan susu oat, disajikan dingin atau panas.', 'https://images.unsplash.com/photo-1536256263959-770b48d82b0a?w=600&q=80', 1),
('Jus Alpukat', 'Minuman', 20000, 'Jus alpukat segar dengan susu kental manis dan topping coklat.', 'https://images.unsplash.com/photo-1621506289937-a8e4df240d0b?w=600&q=80', 0),
('Teh Tarik', 'Minuman', 15000, 'Teh tarik khas Malaysia dengan aroma rempah lembut.', 'https://images.unsplash.com/photo-1571934811356-5cc061b6821f?w=600&q=80', 0),
('Tiramisu Slice', 'Dessert', 32000, 'Tiramisu klasik Italia dengan mascarpone premium dan espresso.', 'https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?w=600&q=80', 1),
('Lava Cake Coklat', 'Dessert', 35000, 'Molten chocolate lava cake dengan isian coklat lumer.', 'https://images.unsplash.com/photo-1563805042-7684c019e1cb?w=600&q=80', 1),
('Pancake Stack', 'Dessert', 30000, 'Tumpukan pancake fluffy dengan maple syrup, butter, dan buah segar.', 'https://images.unsplash.com/photo-1528207776546-365bb710ee93?w=600&q=80', 0),
('Paket Hemat Duo', 'Makanan', 55000, 'Nasi goreng dan es kopi susu, hemat untuk dua orang.', 'https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?w=600&q=80', 0);

INSERT INTO stok_menu (id_menu, jumlah_stok, minimum_stok) VALUES
(1,24,5),(2,18,5),(3,12,5),(4,0,5),(5,30,5),(6,16,5),(7,10,5),(8,28,5),(9,8,5),(10,6,5),(11,14,5),(12,5,5);
...
VALUES
(1, 1, 3, 3, 126000, 63000, 'pending'),
(1, NULL, 2, 1, 69000, 69000, 'diproses');
...
INSERT INTO payment (id_pesanan, id_admin, bukti_tf, status_payment, tanggal_upload, catatan_admin, tanggal_verifikasi)
VALUES
(1, NULL, NULL, 'pending', NULL, NULL, NULL),
(2, 1, NULL, 'verified', NOW(), 'Pembayaran demo sudah valid.', NOW());
